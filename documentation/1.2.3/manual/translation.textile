...
p(note). La documentación está almacenada en formato "textile":http://en.wikipedia.org/wiki/Textile_(markup_language), que es un formato muy simple, pensado para que pueda ser leido y editado por seres humanos, sin necesidad de ninguna herramienta específica. De todas maneras, no necesitas saber textile para traducir la documentación, simplemente debes traducir el texto sin alterar su formato.

Afortunadamente "github":http://github.com viene integrado con un editor de archivos .textile, que es el formato utilizado en la documentación de play, por lo que ni siquiera precisas tener instalado git, ni play, tan sólo con contar con un explorador web y registrarte en github ya podrás colaborar con nosotros.
...
Cuando termines de editar el archivo presiona el botón _Propose file change_ para enviarnos los cambios. ¡Y eso es todo!

h2. <a name="translating">Traduciendo la documentación con el proyecto instalado en tu máquina</a>

Otra opción es instar en tu estación de trabajo todo el proyecto para ir viendo cómo quedarán los cambios a medida que traduces los archivos. Para ello, puedes obtener el proyecto playdoces bajándote la "aplicación comprimida":https://github.com/opensas/playdoces/downloads o clonando el "repositorio de la aplicación":https://github.com/opensas/playdoces. Si no tienes experiencia colaborando con otros proyectos de github, puedes consultar nuestra "guía para colaborar con un proyecto github":github.
